...
public class EcranDialModifAnimal extends JDialog {
	...
	public EcranDialModifAnimal(Animal animal) throws BLLException {
		...
		contentPanel.setLayout(gbl_contentPanel);
		{
			...
			nomClientField.setText(animal.getNomAnimal());
			...
			nomAnimalField.setText(animal.getNomAnimal());
			...
			comboBoxSexe.setSelectedItem(animal.getSexe());
			...
			couleurField.setText(animal.getCouleur());
			...
			comboboxEspece.getModel().setSelectedItem(animal.getRace());
			...
			tatouageField.setText(animal.getTatouage());
			...
			comboBoxRace.setSelectedItem(animal.getEspece());
